                ...
                <ul className="sidebar-menu">
                    {role === "Thủ kho" && (
                        <>
                            ...
                            <MenuItem to="/xuatkho" icon={<FaBoxOpen />} label="Quản lý xuất kho" isCollapsed={isCollapsed} />
                            ...
                            <MenuItem to="/kiemke" icon={<FaWarehouse />} label="Kiểm kê hàng hóa" isCollapsed={isCollapsed} />
